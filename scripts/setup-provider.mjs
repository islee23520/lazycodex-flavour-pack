...
export function resolveProviderOverride(args, options = {}) {
  ...
  if (provided.length !== 4) {
    throw new Error(
      "Provider override requires all four values: --provider-id / LFP_PROVIDER_ID, --provider-base-url / LFP_PROVIDER_BASE_URL, --provider-wire-api / LFP_PROVIDER_WIRE_API, --provider-api-key-env / LFP_PROVIDER_API_KEY_ENV"
    );
  }
