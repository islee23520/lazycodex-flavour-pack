export const BENCHMARK_SCENARIOS = {
  explorer: {
    prompt:
      'Given this repo map: scripts/cli.mjs is the CLI entrypoint, scripts/sync-agent-overrides.mjs syncs agent TOML files. Return compact JSON with {"path":"<entrypoint>","reason":"<why>"}.',
