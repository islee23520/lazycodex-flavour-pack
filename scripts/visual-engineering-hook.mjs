...
These vision agents default to Gemini models (gemini-pro-agent) in their role configs because Gemini provides strong detailed visual understanding, evidence extraction from screenshots/diagrams/charts, layout analysis, and verification tasks. Your active model_provider must be configured to route the Gemini model name.
