...
import { createProviderConsentSelector } from "../provider/setup-provider-tui.js";
import { createGitHubStartSelector, createModelSelector, createReasoningSelector, createTierSelector, createYesNoSelector } from "./setup-tui-selectors.js";
...
export async function runSetupTui(args, context, deps = {}) {
    ...
    if (runLineSetup === undefined)
        throw new Error("runSetupTui requires runLineSetup");
