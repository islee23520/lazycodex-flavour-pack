...
const TRIGGER = /\b(?:skill manager|skill-manager|skills?|restore skill|find skill|archived skill|disabled skill)\b|(?:스킬|자동정리|스킬\s*정리)/i;
...
export function runSkillManagerGuidance(input = {}) {
    if (input?.hook_event_name !== "UserPromptSubmit")
        return { emit: false, reason: "wrong-event" };
